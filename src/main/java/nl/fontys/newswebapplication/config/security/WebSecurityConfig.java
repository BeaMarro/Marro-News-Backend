package nl.fontys.newswebapplication.config.security;

import lombok.Generated;
import nl.fontys.newswebapplication.config.security.auth.AuthenticationRequestFilter;
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(registry ->
                        registry.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()                 // CORS pre-flight requests should be public
                                .requestMatchers(HttpMethod.GET, "/articles", "/articles/**", "/ws/**", "/error", "/journalists/{id}").permitAll() // Adding public access endpoints
                                .requestMatchers(HttpMethod.POST, "/tokens", "/users", "/error").permitAll()
